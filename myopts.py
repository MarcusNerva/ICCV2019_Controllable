...
def parse_opt():
    ...
    parser.add_argument('--learning_rate_decay_every', type=int, default=3, help='for every x iteration learning rate have to decay')
    parser.add_argument('--learning_rate_decay_rate', type=float, default=0.4)
